...
# ---------------------------------------------------------------------------
# 15 SAMPLE jobs. ALL attributed to "SampleCo (demo)", is_sample=true. NEVER counted in metrics.
# ---------------------------------------------------------------------------
...
SAMPLE_JOBS: list[dict] = [
    ...
    {"title": "Battery Test Engineer", "family": "battery systems/test",
     ...
     "jd": "Design and execute cell-level and module-level test plans. Own bench safety and DAQ instrumentation. Reduce test cycle time."},
    ...
    {"title": "Battery Thermal Engineer", "family": "thermal/energy",
     ...
     "jd": "Design pack-level thermal management. 1D + 3D correlation. Own coolant flow and cell temperature targets under fast-charge."},
    ...
    {"title": "Vehicle Test Engineer", "family": "test engineer",
     ...
     "jd": "Plan and execute proving-ground validation cycles. Author test plans, run DAQ, deliver crisp reports."},
    {"title": "Autonomy Systems Engineer", "family": "robotics",
     "geo": "Mountain View, CA", "comp": "$150k–$210k", "apply_method": "ats-greenhouse",
     "jd": "Own end-to-end autonomy stack integration for a driverless platform. Perception ↔ planning integration and safety case authoring."},
    ...
    {"title": "Manufacturing Process Engineer", "family": "manufacturing/process",
     ...
     "jd": "Own line-side process for a new battery module assembly cell. Cycle-time analysis, PFMEA ownership, kaizen leadership."},
    {"title": "Fab Equipment Engineer", "family": "equipment engineer",
     "geo": "Chandler, AZ", "comp": "$105k–$140k", "apply_method": "external",
     "jd": "Own uptime, yield, and MTBF for a critical fab-line tool. Partner with vendors on preventive-maintenance windows."},
...
# All claims start with user_approved=false, verification level 0.
# ---------------------------------------------------------------------------
USER_ZERO = {
...
USER_ZERO_CLAIMS = [
    {
        "type": "identity",
        "value": {"name": "Ujjwal Singla"},
        "sensitivity": "normal",
    },
    {
        "type": "location",
        "value": {"city": "Phoenix", "state": "AZ", "country": "US"},
        "sensitivity": "normal",
    },
    {
        "type": "work_auth",
        "value": {"status": "unspecified", "note": "Eligibility to be confirmed by candidate."},
        "sensitivity": "sealed",
    },
    {
        "type": "education",
        "value": {
            ...
            "institution": None,  # left blank pending user confirmation
